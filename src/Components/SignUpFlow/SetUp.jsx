...
const  SetUp = (props) => {
  function OnFormProfileInfo(e){
    ...
    props.handleSetUp({org:org,first: first, last: last})
  }
...
<Card.Header style={{backgroundColor:"white", border:"none"}}>
              ...
              <p style={{color:"grey", fontSize:"small"}}>We suggest using the email address you use at Work</p>
          </Card.Header>
          <Card.Body>
          <Form onSubmit={OnFormProfileInfo}>
              <Form.Group>
              <Form.Label style={{textAlign:"left"}} >Organization</Form.Label>
              <Form.Control
                  type="text"
                  name="organization"
              />
              ...
              <Form.Group className="mb-3">
                  ...
                  <Form.Control placeholder="First" name="first" />
              </Form.Group>
              <div style={{margin:"10px"}} />
              <Form.Group className="mb-3">
                  <Form.Label>Last Name</Form.Label>
                  <Form.Control type="text" placeholder="Last" name="last" />
              </Form.Group>
